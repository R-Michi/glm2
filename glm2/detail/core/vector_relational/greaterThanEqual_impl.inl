...
{
    __m128i xmm0;
    xmm0 = _mm_castpd_si128(_mm_cmpge_pd(x, y));
...
inline __m128i glm2::detail::core::vector_relational::greaterThanEqual::_default_u32v(__m128i x, __m128i y)
{
    __m128i xmm0, xmm1, xmm2;
    xmm0 = _mm_set1_epi32(0x80000000);  // flip sign bits
    xmm1 = _mm_xor_si128(xmm0, x);
    xmm2 = _mm_xor_si128(xmm0, y);
    xmm0 = _mm_cmpgt_epi32(xmm1, xmm2);
    xmm1 = _mm_cmpeq_epi32(xmm1, xmm2);
    return _mm_or_si128(xmm0, xmm1);
}
