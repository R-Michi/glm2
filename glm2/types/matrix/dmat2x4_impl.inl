...
* @brief    Implemantation of the 2x4 double matrix.
...
inline glm2::mat<2, 4, double>::mat(void)
{
    *this = 0.0;
}
inline glm2::mat<2, 4, double>::mat(double d)
{
    *this = d;
}
...
inline glm2::mat<2, 4, double> glm2::mat<2, 4, double>::operator+ (double d) const
{
    mat _M = *this;
    _M += d;
    return _M;
}
inline glm2::mat<2, 4, double> glm2::mat<2, 4, double>::operator+ (const col_type& v) const
{
    mat _M = *this;
    _M += v;
    return _M;
}
inline glm2::mat<2, 4, double> glm2::mat<2, 4, double>::operator+ (const mat& M) const
{
    mat _M = *this;
    _M += M;
    return _M;
...
inline glm2::mat<2, 4, double> glm2::mat<2, 4, double>::operator+ (void) const
{
    return *this;
}
inline glm2::mat<2, 4, double> glm2::mat<2, 4, double>::operator- (void) const
...
inline glm2::mat<2, 4, double>& glm2::mat<2, 4, double>::operator++ (void)
{
    __m256d ymm0;
...
inline glm2::mat<2, 4, double>::col_type& glm2::mat<2, 4, double>::operator[] (uint32_t i)
{
    return this->_M[i];
}
...
inline double* glm2::mat<2, 4, double>::value_ptr(mat* Mv)
{
    return col_type::value_ptr(Mv->_M);
}
inline const double* glm2::mat<2, 4, double>::value_ptr(const mat& M)
{
    return col_type::value_ptr(M._M);
}
inline const double* glm2::mat<2, 4, double>::value_ptr(const mat* Mv)
{
    return col_type::value_ptr(Mv->_M);
}

inline __m256d* glm2::mat<2, 4, double>::intrin_ptr(mat& M)
{
    return col_type::intrin_ptr(M._M);
}
inline __m256d* glm2::mat<2, 4, double>::intrin_ptr(mat* Mv)
{
    return col_type::intrin_ptr(Mv->_M);
}
inline const __m256d* glm2::mat<2, 4, double>::intrin_ptr(const mat& M)
{
    return col_type::intrin_ptr(M._M);
}
inline const __m256d* glm2::mat<2, 4, double>::intrin_ptr(const mat* Mv)
{
    return col_type::intrin_ptr(Mv->_M);
}
