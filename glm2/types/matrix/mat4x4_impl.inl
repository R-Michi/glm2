...
inline glm2::mat<4, 4, float>& glm2::mat<4, 4, float>::operator= (const float* fv)
{
...
inline glm2::mat<4, 4, float>& glm2::mat<4, 4, float>::operator= (const col_type* vv)
{
    this->_M[0] = vv[0];
    this->_M[1] = vv[1];
    this->_M[2] = vv[2];
...
inline glm2::mat<4, 4, float>& glm2::mat<4, 4, float>::operator= (const __m128* m128v)
{
    this->_M[0] = m128v[0];
    this->_M[1] = m128v[1];
    this->_M[2] = m128v[2];
...
inline glm2::mat<4, 4, float>& glm2::mat<4, 4, float>::operator= (const __m256* m256v)
{
