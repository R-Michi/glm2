...
{
    __m256d ymm0, ymm1;
    ymm0 = _mm256_castsi256_pd(_mm256_broadcastsi128_si256(_mm_castpd_si128(v.intrin())));
    ymm1 = _mm256_loadu_pd(col_type::value_ptr(this->_M + 0));
    ymm1 = _mm256_add_pd(ymm1, ymm0);
    _mm256_storeu_pd(col_type::value_ptr(this->_M + 0), ymm1);
    ymm1 = _mm256_loadu_pd(col_type::value_ptr(this->_M + 2));
...
inline glm2::mat<4, 2, double>& glm2::mat<4, 2, double>::load(const double* src)
{
...
inline glm2::mat<4, 2, double>& glm2::mat<4, 2, double>::load(const col_type* src)
{
    this->_M[0] = src[0];
    this->_M[1] = src[1];
    this->_M[2] = src[2];
...
inline glm2::mat<4, 2, double>& glm2::mat<4, 2, double>::load(const __m128d* src)
{
    this->_M[0] = src[0];
    this->_M[1] = src[1];
    this->_M[2] = src[2];
...
inline glm2::mat<4, 2, double>& glm2::mat<4, 2, double>::load(const __m256d* src)
{
    _mm256_storeu_pd(col_type::value_ptr(this->_M + 0), src[0]);
    _mm256_storeu_pd(col_type::value_ptr(this->_M + 2), src[1]);
    return *this;
}
inline void glm2::mat<4, 2, double>::store(double* dst) const
{
...
inline void glm2::mat<4, 2, double>::store(col_type* dst) const
{
    dst[0] = this->_M[0];
    dst[1] = this->_M[1];
    dst[2] = this->_M[2];
...
inline void glm2::mat<4, 2, double>::store(__m128d* dst) const
{
...
inline void glm2::mat<4, 2, double>::store(__m256d* dst) const
{
    dst[0] = _mm256_loadu_pd(col_type::value_ptr(this->_M + 0));
    dst[1] = _mm256_loadu_pd(col_type::value_ptr(this->_M + 2));
}
