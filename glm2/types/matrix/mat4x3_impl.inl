...
inline glm2::mat<4, 3, float>& glm2::mat<4, 3, float>::load(const float* src)
{
...
inline glm2::mat<4, 3, float>& glm2::mat<4, 3, float>::load(const col_type* src)
{
    this->_M[0] = src[0];
    this->_M[1] = src[1];
    this->_M[2] = src[2];
...
inline glm2::mat<4, 3, float>& glm2::mat<4, 3, float>::load(const __m128* src)
{
    this->_M[0] = src[0];
    this->_M[1] = src[1];
    this->_M[2] = src[2];
...
inline glm2::mat<4, 3, float>& glm2::mat<4, 3, float>::load(const __m256* src)
{
    _mm256_storeu_ps(col_type::value_ptr(this->_M + 0), src[0]);
    _mm256_storeu_ps(col_type::value_ptr(this->_M + 2), src[1]);
    return *this;
}
inline void glm2::mat<4, 3, float>::store(float* dst) const
{
...
inline void glm2::mat<4, 3, float>::store(col_type* dst) const
{
    dst[0] = this->_M[0];
    dst[1] = this->_M[1];
    dst[2] = this->_M[2];
...
inline void glm2::mat<4, 3, float>::store(__m128* dst) const
{
...
inline void glm2::mat<4, 3, float>::store(__m256* dst) const
{
