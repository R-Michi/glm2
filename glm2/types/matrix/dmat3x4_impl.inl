...
* @brief    Implemantation of the 3x4 double matrix.
...
inline glm2::mat<3, 4, double>::mat(void)
{
    *this = 0.0;
}
inline glm2::mat<3, 4, double>::mat(double d)
{
    *this = d;
}
inline glm2::mat<3, 4, double>::mat(
...
inline glm2::mat<3, 4, double>::mat(const double* dv)
{
    *this = this->load(dv);
}
inline glm2::mat<3, 4, double>::mat(
...
inline glm2::mat<3, 4, double>::mat(const col_type* vv)
{
    *this = this->load(vv);
}
inline glm2::mat<3, 4, double>::mat(const __m256d* m256v)
{
    *this = this->load(m256v);
}
inline glm2::mat<3, 4, double>::mat(const mat& M)
{
    *this = M;
}

inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator= (double d)
{
    this->_M[0] = d;
    this->_M[1] = d;
    this->_M[2] = d;
...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator= (const mat& M)
{
    this->_M[0] = M._M[0];
    this->_M[1] = M._M[1];
    this->_M[2] = M._M[2];
...
inline bool glm2::mat<3, 4, double>::operator== (const mat& M) const
{
...
inline glm2::mat<3, 4, double> glm2::mat<3, 4, double>::operator+ (double d) const
{
    mat _M = *this;
    _M += d;
    return _M;
}
inline glm2::mat<3, 4, double> glm2::mat<3, 4, double>::operator+ (const col_type& v) const
{
    mat _M = *this;
    _M += v;
    return _M;
}
inline glm2::mat<3, 4, double> glm2::mat<3, 4, double>::operator+ (const mat& M) const
{
    mat _M = *this;
    _M += M;
    return _M;
...
inline glm2::mat<3, 4, double> glm2::mat<3, 4, double>::operator+ (void) const
{
    return *this;
}
inline glm2::mat<3, 4, double> glm2::mat<3, 4, double>::operator- (void) const
...
inline glm2::mat<3, 4, double> glm2::mat<3, 4, double>::operator++ (int)
{
    mat M = *this;
    ++*this;
    return M;
}
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator++ (void)
{
    __m256d ymm0;
...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator+= (const col_type& v)
{
...
inline glm2::mat<3, 4, double>::col_type& glm2::mat<3, 4, double>::operator[] (uint32_t i)
{
    return this->_M[i];
}
inline const glm2::mat<3, 4, double>::col_type& glm2::mat<3, 4, double>::operator[] (uint32_t i) const
{   
    return this->_M[i];
}
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::load(const double* src)
{
...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::load(const col_type* src)
{
    this->_M[0] = src[0];
    this->_M[1] = src[1];
    this->_M[2] = src[2];
...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::load(const __m256d* src)
{
    this->_M[0] = src[0];
    this->_M[1] = src[1];
    this->_M[2] = src[2];
...
inline void glm2::mat<3, 4, double>::store(double* dst) const
{
    this->_M[0].store(dst + 0);
    this->_M[1].store(dst + 4);
    this->_M[2].store(dst + 8);
}
inline void glm2::mat<3, 4, double>::store(col_type* dst) const
{
    dst[0] = this->_M[0];
    dst[1] = this->_M[1];
    dst[2] = this->_M[2];
}
inline void glm2::mat<3, 4, double>::store(__m256d* dst) const
{
...
inline double* glm2::mat<3, 4, double>::value_ptr(mat& M)
{
    return col_type::value_ptr(M._M);
}
inline double* glm2::mat<3, 4, double>::value_ptr(mat* Mv)
{
    return col_type::value_ptr(Mv->_M);
}
inline const double* glm2::mat<3, 4, double>::value_ptr(const mat& M)
{
    return col_type::value_ptr(M._M);
}
inline const double* glm2::mat<3, 4, double>::value_ptr(const mat* Mv)
{
    return col_type::value_ptr(Mv->_M);
}

inline __m256d* glm2::mat<3, 4, double>::intrin_ptr(mat& M)
{
    return col_type::intrin_ptr(M._M);
}   
inline __m256d* glm2::mat<3, 4, double>::intrin_ptr(mat* Mv)
{
    return col_type::intrin_ptr(Mv->_M);
}
inline const __m256d* glm2::mat<3, 4, double>::intrin_ptr(const mat& M)
{
    return col_type::intrin_ptr(M._M);
}
inline const __m256d* glm2::mat<3, 4, double>::intrin_ptr(const mat* Mv)
{
    return col_type::intrin_ptr(Mv->_M);
}   
