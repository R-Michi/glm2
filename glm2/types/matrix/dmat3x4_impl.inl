...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator= (const double* dv)
{
...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator= (const col_type* vv)
{
    this->_M[0] = vv[0];
    this->_M[1] = vv[1];
    this->_M[2] = vv[2];
...
inline glm2::mat<3, 4, double>& glm2::mat<3, 4, double>::operator= (const __m256d* m256v)
{
    this->_M[0] = m256v[0];
    this->_M[1] = m256v[1];
    this->_M[2] = m256v[2];
