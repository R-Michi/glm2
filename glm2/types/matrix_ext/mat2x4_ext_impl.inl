...
* @brief    Implamentation of convert operators, extended mathematical operators 
            and extended constructors of a 2x4 float matrix.
...
inline glm2::mat<2, 4, float>::col_type glm2::mat<2, 4, float>::operator* (const row_type& v) const
{
    __m128 xmm0, xmm1;
...
inline glm2::mat<2, 4, float> glm2::mat<2, 4, float>::operator* (const mat<2, 2, float>& M) const
{
    mat _M = *this;
    _M *= M;
    return _M;
}
inline glm2::mat<3, 4, float> glm2::mat<2, 4, float>::operator* (const mat<3, 2, float>& M) const
{
    mat<3, 4, float> res;
...
inline glm2::mat<4, 4, float> glm2::mat<2, 4, float>::operator* (const mat<4, 2, float>& M) const
{
    mat<4, 4, float> res;
    ...
    _mm256_storeu_ps(mat<4, 4, float>::value_ptr(res) + 0, ymm1);
    _mm256_storeu_ps(mat<4, 4, float>::value_ptr(res) + 8, ymm0);
    return res;
}

inline glm2::mat<2, 4, float>& glm2::mat<2, 4, float>::operator*= (const mat<2, 2, float>& M)
{
    __m256 ymm0, ymm1, ymm2, ymm3;
...
inline glm2::mat<2, 4, float>::operator glm2::mat<2, 2, float>(void) const
{
    mat<2, 2, float> res;
...
inline glm2::mat<2, 4, float>::operator glm2::mat<2, 3, float>(void) const
{
    mat<2, 3, float> res;
...
inline glm2::mat<2, 4, float>::operator glm2::mat<3, 2, float>(void) const
{
    mat<3, 2, float> res;
    res[0] = (vec2)this->_M[0];
    res[1] = (vec2)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<3, 3, float>(void) const
{
    mat<3, 3, float> res;
    res[0] = (vec3)this->_M[0];
    res[1] = (vec3)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<3, 4, float>(void) const
{
    mat<3, 4, float> res;
    res[0] = this->_M[0];
    res[1] = this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<4, 2, float>(void) const
{
    mat<4, 2, float> res;
    res[0] = (vec2)this->_M[0];
    res[1] = (vec2)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<4, 3, float>(void) const
{
    mat<4, 3, float> res;
    res[0] = (vec3)this->_M[0];
    res[1] = (vec3)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<4, 4, float>(void) const
{
    mat<4, 4, float> res;
    res[0] = this->_M[0];
    res[1] = this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<2, 2, double>(void) const
{
    mat<2, 2, double> res;
...
inline glm2::mat<2, 4, float>::operator glm2::mat<2, 3, double>(void) const
{
    mat<2, 3, double> res;
...
inline glm2::mat<2, 4, float>::operator glm2::mat<2, 4, double>(void) const
{
    mat<2, 4, double> res;
...
inline glm2::mat<2, 4, float>::operator glm2::mat<3, 2, double>(void) const
{
    mat<3, 2, double> res;
    res[0] = (dvec2)this->_M[0];
    res[1] = (dvec2)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<3, 3, double>(void) const
{
    mat<3, 3, double> res;
    res[0] = (dvec3)this->_M[0];
    res[1] = (dvec3)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<3, 4, double>(void) const
{
    mat<3, 4, double> res;
    res[0] = (dvec4)this->_M[0];
    res[1] = (dvec4)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<4, 2, double>(void) const
{
    mat<4, 2, double> res;
    res[0] = (dvec2)this->_M[0];
    res[1] = (dvec2)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<4, 3, double>(void) const
{
    mat<4, 3, double> res;
    res[0] = (dvec3)this->_M[0];
    res[1] = (dvec3)this->_M[1];
...
inline glm2::mat<2, 4, float>::operator glm2::mat<4, 4, double>(void) const
{
    mat<4, 4, double> res;
    res[0] = (dvec4)this->_M[0];
    res[1] = (dvec4)this->_M[1];
