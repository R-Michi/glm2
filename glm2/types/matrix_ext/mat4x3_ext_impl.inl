...
* @brief    Implamentation of convert operators, extended mathematical operators 
            and extended constructors of a 4x3 float matrix.
...
inline glm2::mat<4, 3, float>::col_type glm2::mat<4, 3, float>::operator* (const row_type& v) const
{
    __m256 ymm0, ymm1;
    __m128 xmm0;
...
inline glm2::mat<2, 3, float> glm2::mat<4, 3, float>::operator* (const mat<2, 4, float>& M) const
{
    mat<2, 3, float> res;
...
inline glm2::mat<3, 3, float> glm2::mat<4, 3, float>::operator* (const mat<3, 4, float>& M) const
{
    mat<3, 3, float> res;
    __m256 ymm0, ymm1, ymm2, ymm3, ymm4, ymm5, ymm6, ymm7;
...
inline glm2::mat<4, 3, float> glm2::mat<4, 3, float>::operator* (const mat<4, 4, float>& M) const
{
    mat _M = *this;
    _M *= M;
    return _M;
...
inline glm2::mat<4, 3, float>& glm2::mat<4, 3, float>::operator*= (const mat<4, 4, float>& M)
{
    __m256 ymm0, ymm1, ymm2, ymm3, ymm4, ymm5, ymm6, ymm7;
    ...
    ymm0 = _mm256_loadu_ps(mat<4, 4, float>::value_ptr(M) + 8);
    ymm5 = _mm256_permute_ps(ymm0, 0x00);
    ymm6 = _mm256_permute_ps(ymm0, 0x55);
    ymm7 = _mm256_permute_ps(ymm0, 0xAA);
    ymm0 = _mm256_permute_ps(ymm0, 0xFF);
...
inline glm2::mat<4, 3, float>::operator glm2::mat<2, 2, float>(void) const
{
    mat<2, 2, float> res;
...
inline glm2::mat<4, 3, float>::operator glm2::mat<2, 3, float>(void) const
{
    mat<2, 3, float> res;
    res[0] = this->_M[0];
    res[1] = this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<2, 4, float>(void) const
{
    mat<2, 4, float> res;
    res[0] = this->_M[0]();
    res[1] = this->_M[1]();
...
inline glm2::mat<4, 3, float>::operator glm2::mat<3, 2, float>(void) const
{
    mat<3, 2, float> res;
    res[0] = (vec2)this->_M[0];
    res[1] = (vec2)this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<3, 3, float>(void) const
{
    mat<3, 3, float> res;
    res[0] = this->_M[0];
    res[1] = this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<3, 4, float>(void) const
{
    mat<3, 4, float> res;
    res[0] = this->_M[0]();
    res[1] = this->_M[1]();
...
inline glm2::mat<4, 3, float>::operator glm2::mat<4, 2, float>(void) const
{
    mat<4, 2, float> res;
    res[0] = (vec2)this->_M[0];
    res[1] = (vec2)this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<4, 4, float>(void) const
{
    mat<4, 4, float> res;
    res[0] = this->_M[0]();
    res[1] = this->_M[1]();
...
inline glm2::mat<4, 3, float>::operator glm2::mat<2, 2, double>(void) const
{
    mat<2, 2, double> res;
...
inline glm2::mat<4, 3, float>::operator glm2::mat<2, 3, double>(void) const
{
    mat<2, 3, double> res;
...
inline glm2::mat<4, 3, float>::operator glm2::mat<2, 4, double>(void) const
{
    mat<2, 4, double> res;
...
inline glm2::mat<4, 3, float>::operator glm2::mat<3, 2, double>(void) const
{
    mat<3, 2, double> res;
    res[0] = (dvec2)this->_M[0];
    res[1] = (dvec2)this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<3, 3, double>(void) const
{
    mat<3, 3, double> res;
    res[0] = (dvec3)this->_M[0];
    res[1] = (dvec3)this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<3, 4, double>(void) const
{
    mat<3, 4, double> res;
    res[0] = _mm256_cvtps_pd(this->_M[0]());
    res[1] = _mm256_cvtps_pd(this->_M[1]());
    res[2] = _mm256_cvtps_pd(this->_M[2]());
    return res;
}
inline glm2::mat<4, 3, float>::operator glm2::mat<4, 2, double>(void) const
{
    mat<4, 2, double> res;
    res[0] = (dvec2)this->_M[0];
    res[1] = (dvec2)this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<4, 3, double>(void) const
{
    mat<4, 3, double> res;
    res[0] = (dvec3)this->_M[0];
    res[1] = (dvec3)this->_M[1];
...
inline glm2::mat<4, 3, float>::operator glm2::mat<4, 4, double>(void) const
{
    mat<4, 4, double> res;
    res[0] = _mm256_cvtps_pd(this->_M[0]());
    res[1] = _mm256_cvtps_pd(this->_M[1]());
    res[2] = _mm256_cvtps_pd(this->_M[2]());
    res[3] = _mm256_cvtps_pd(this->_M[3]());
    return res;
}
