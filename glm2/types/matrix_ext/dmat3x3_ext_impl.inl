...
inline glm2::mat<3, 3, double>::col_type glm2::mat<3, 3, double>::operator* (const row_type& v) const
{
    ...
    ymm0 = _mm256_permute4x64_pd(v(), 0x00);    // x, x, x, x
    ymm1 = _mm256_permute4x64_pd(v(), 0x55);    // y, y, y, y
    ymm2 = _mm256_permute4x64_pd(v(), 0xAA);    // z, z, z, z
...
inline glm2::mat<3, 3, double>::operator glm2::mat<3, 4, float>(void) const
{
    ...
    res[0] = _mm256_castps256_ps128(_mm256_castpd_ps(this->_M[0]()));
    res[1] = _mm256_castps256_ps128(_mm256_castpd_ps(this->_M[1]()));
    res[2] = _mm256_castps256_ps128(_mm256_castpd_ps(this->_M[2]()));
    return res;
}
