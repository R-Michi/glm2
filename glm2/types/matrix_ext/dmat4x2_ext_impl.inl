...
* @brief    Implamentation of convert operators, extended mathematical operators 
            and extended constructors of a 4x2 double matrix.
...
inline glm2::mat<4, 2, double>::col_type glm2::mat<4, 2, double>::operator* (const row_type& v) const
{
    __m256d ymm0;
...
inline glm2::mat<2, 2, double> glm2::mat<4, 2, double>::operator* (const mat<2, 4, double>& M) const
{
    mat<2, 2, double> res;
    ...
    ymm6 = _mm256_permute_pd(ymm6, 0x0F);
    ymm7 = _mm256_permute_pd(ymm4, 0x00);
    ymm4 = _mm256_permute_pd(ymm4, 0x0F);
    ymm0 = _mm256_mul_pd(ymm5, ymm0);
    ymm0 = _mm256_fmadd_pd(ymm6, ymm1, ymm0);
    ymm0 = _mm256_fmadd_pd(ymm7, ymm2, ymm0);
    ymm0 = _mm256_fmadd_pd(ymm4, ymm3, ymm0);
    _mm256_storeu_pd(mat<2, 2, double>::value_ptr(res), ymm0);
    return res;
}
inline glm2::mat<3, 2, double> glm2::mat<4, 2, double>::operator* (const mat<3, 4, double>& M) const
{
    mat<3, 2, double> res;
    __m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm5, ymm6, ymm7;
    ...
    ymm7 = _mm256_permute_pd(ymm4, 0x00);
    ymm4 = _mm256_permute_pd(ymm4, 0x0F);
    ymm4 = _mm256_mul_pd(ymm4, ymm3);
    ymm4 = _mm256_fmadd_pd(ymm6, ymm1, ymm4);
    ymm4 = _mm256_fmadd_pd(ymm7, ymm2, ymm4);
    ymm4 = _mm256_fmadd_pd(ymm5, ymm0, ymm4);
    _mm256_storeu_pd(mat<3, 2, double>::value_ptr(res), ymm4);
    xmm0 = _mm256_castpd256_pd128(ymm0);
    ...
    xmm4 = _mm_permute_pd(xmm4, 0x03);
    xmm7 = _mm_permute_pd(xmm5, 0x00);
    xmm5 = _mm_permute_pd(xmm5, 0x03);
    xmm0 = _mm_mul_pd(xmm6, xmm0);
    xmm0 = _mm_fmadd_pd(xmm4, xmm1, xmm0);
    xmm0 = _mm_fmadd_pd(xmm7, xmm2, xmm0);
    xmm0 = _mm_fmadd_pd(xmm5, xmm3, xmm0);
    res[2] = xmm0;
    return res;
}
inline glm2::mat<4, 2, double> glm2::mat<4, 2, double>::operator* (const mat<4, 4, double>& M) const
{
    mat _M = *this;
    _M *= M;
    return _M;
...
inline glm2::mat<4, 2, double>& glm2::mat<4, 2, double>::operator*= (const mat<4, 4, double>& M)
{
    __m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm5, ymm6, ymm7;
    ymm0 = _mm256_broadcast_pd(col_type::intrin_ptr(this->_M) + 0);
    ymm1 = _mm256_broadcast_pd(col_type::intrin_ptr(this->_M) + 1);
...
inline glm2::mat<4, 2, double>::operator glm2::mat<2, 2, float>(void) const
{
    mat<2, 2, float> res;
...
inline glm2::mat<4, 2, double>::operator glm2::mat<2, 2, double>(void) const
{
    mat<2, 2, double> res;
    res[0] = this->_M[0];
    res[1] = this->_M[1];
