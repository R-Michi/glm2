...
{
    return detail::core::vector_relational::greaterThanEqual::_default_u32v(x.si128(), y.si128());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::greaterThanEqual(const vec<3, uint32_t>& x, const vec<3, uint32_t>& y)
{
    return detail::core::vector_relational::greaterThanEqual::_default_u32v(x(), y());
}
