...
{
    return detail::core::vector_relational::greaterThanEqual::_default_fv(x.intrinEXT(), y.intrinEXT());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::greaterThanEqual(const vec<3, float>& x, const vec<3, float>& y)
{
    return detail::core::vector_relational::greaterThanEqual::_default_fv(x.intrin(), y.intrin());
}
...
{
    return detail::core::vector_relational::greaterThanEqual::_default_dv2(x.intrin(), y.intrin());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::greaterThanEqual(const vec<3, double>& x, const vec<3, double>& y)
{
    return detail::core::vector_relational::greaterThanEqual::_default_dv(x.intrin(), y.intrin());
}
...
{
    return detail::core::vector_relational::greaterThanEqual::_default_i32v(x.intrinEXT(), y.intrinEXT());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::greaterThanEqual(const vec<3, int32_t>& x, const vec<3, int32_t>& y)
{
    return detail::core::vector_relational::greaterThanEqual::_default_i32v(x.intrin(), y.intrin());
}
...
{
    return detail::core::vector_relational::greaterThanEqual::_default_u32v(x.intrinEXT(), y.intrinEXT());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::greaterThanEqual(const vec<3, uint32_t>& x, const vec<3, uint32_t>& y)
{
    return detail::core::vector_relational::greaterThanEqual::_default_u32v(x.intrin(), y.intrin());
}
