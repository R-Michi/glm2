...
{
    return detail::core::vector_relational::lessThanEqual::_default_fv(x.si128(), y.si128());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::lessThanEqual(const vec<3, float>& x, const vec<3, float>& y)
{
    return detail::core::vector_relational::lessThanEqual::_default_fv(x(), y());
}
...
{
    return detail::core::vector_relational::lessThanEqual::_default_dv2(x(), y());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::lessThanEqual(const vec<3, double>& x, const vec<3, double>& y)
{
    return detail::core::vector_relational::lessThanEqual::_default_dv(x(), y());
}
...
{
    return detail::core::vector_relational::lessThanEqual::_default_i32v(x.si128(), y.si128());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::lessThanEqual(const vec<3, int32_t>& x, const vec<3, int32_t>& y)
{
    return detail::core::vector_relational::lessThanEqual::_default_i32v(x(), y());
}
...
{
    return detail::core::vector_relational::lessThanEqual::_default_u32v(x.si128(), y.si128());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::lessThanEqual(const vec<3, uint32_t>& x, const vec<3, uint32_t>& y)
{
    return detail::core::vector_relational::lessThanEqual::_default_u32v(x(), y());
}
