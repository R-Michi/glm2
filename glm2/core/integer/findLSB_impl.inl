...
{
    int32_t ret;
    __m128 xmm0 = detail::core::integer::findLSB::_default_u32v(_mm_loadu_si32(&x));
    _mm_storeu_si32(&ret);
    return ret;
}
...
{
    return detail::core::integer::findLSB::_default_u32v(x.si128());
}
template<typename T> inline glm2::vec<3, int32_t> glm2::findLSB(const vec<3, T>& x)
{
    return detail::core::integer::findLSB::_default_u32v(x());
}
