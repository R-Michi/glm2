...
{
    return detail::core::common::min::_default_fv(x.si128(), _mm_set_ps1(y));
}
template<> inline glm2::vec<3, float> glm2::min(const vec<3, float>& x, float y)
{
    return detail::core::common::min::_default_fv(x(), _mm_set_ps1(y));
}
...
{
    return detail::core::common::min::_default_dv2(x(), _mm_set1_pd(y));
}
template<> inline glm2::vec<3, double> glm2::min(const vec<3, double>& x, double y)
{
    return detail::core::common::min::_default_dv(x(), _mm256_set1_pd(y));
}
...
{
    return detail::core::common::min::_default_u32v(x.si128(), _mm_set1_epi32(y));
}
template<> inline glm2::vec<3, uint32_t> glm2::min(const glm2::vec<3, uint32_t>& x, uint32_t y)
{
    return detail::core::common::min::_default_u32v(x(), _mm_set1_epi32(y));
}
...
{
    return detail::core::common::min::_default_fv(x(), y());
}
...
{
    return detail::core::common::min::_default_dv2(x(), y());
}
...
{
    return detail::core::common::min::_default_u32v(x.si128(), y.si128());
}
template<> inline glm2::vec<3, uint32_t> glm2::min(const glm2::vec<3, uint32_t>& x, const glm2::vec<3, uint32_t>& y)
{
    return detail::core::common::min::_default_u32v(x(), y());
}
