...
{
    return detail::core::common::max::_default_u32v(x.si128(), _mm_set1_epi32(y));
}
template<> inline glm2::vec<3, uint32_t> glm2::max(const glm2::vec<3, uint32_t>& x, uint32_t y)
{
    return detail::core::common::max::_default_u32v(x(), _mm_set1_epi32(y));
}
...
{
    return detail::core::common::max::_default_u32v(x.si128(), y.si128());
}
template<> inline glm2::vec<3, uint32_t> glm2::max(const glm2::vec<3, uint32_t>& x, const glm2::vec<3, uint32_t>& y)
{
    return detail::core::common::max::_default_u32v(x(), y());
}
