...
{
    return detail::core::common::round::_default_fv(x.si128());
}
template<> inline glm2::vec<3, float> glm2::round(const vec<3, float>& x)
{
    return detail::core::common::round::_default_fv(x());
}
...
{
    return detail::core::common::round::_default_dv2(x());
}
template<> inline glm2::vec<3, double> glm2::round(const vec<3, double>& x)
{
    return detail::core::common::round::_default_dv(x());
}
