...
{
    return detail::core::common::mod::_default_fv(x.intrinEXT(), _mm_set_ps1(y));
}
template<> inline glm2::vec<3, float> glm2::mod(const vec<3, float>& x, float y)
{
    return detail::core::common::mod::_default_fv(x.intrin(), _mm_set_ps1(y));
}
...
{
    return detail::core::common::mod::_default_dv2(x.intrin(), _mm_set1_pd(y));
}
template<> inline glm2::vec<3, double> glm2::mod(const vec<3, double>& x, double y)
{
    return detail::core::common::mod::_default_dv(x.intrin(), _mm256_set1_pd(y));
}
...
{
    return detail::core::common::mod::_default_fv(x.intrinEXT(), y.intrinEXT());
}
template<> inline glm2::vec<3, float> glm2::mod(const vec<3, float>& x, const vec<3, float>& y)
{
    return detail::core::common::mod::_default_fv(x.intrin(), y.intrin());
}
...
{
    return detail::core::common::mod::_default_dv2(x.intrin(), y.intrin());
}
template<> inline glm2::vec<3, double> glm2::mod(const vec<3, double>& x, const vec<3, double>& y)
{
    return detail::core::common::mod::_default_dv(x.intrin(), y.intrin());
}
