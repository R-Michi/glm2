...
{
    return detail::core::common::smoothstep::_default_fv(_mm_set_ps1(edge0), _mm_set_ps1(edge1), x.si128());
}
template<> inline glm2::vec<3, float> glm2::smoothstep(float edge0, float edge1, const vec<3, float>& x)
{
    return detail::core::common::smoothstep::_default_fv(_mm_set_ps1(edge0), _mm_set_ps1(edge1), x());
}
...
{
    return detail::core::common::smoothstep::_default_dv2(_mm_set1_pd(edge0), _mm_set1_pd(edge1), x());
}
template<> inline glm2::vec<3, double> glm2::smoothstep(double edge0, double edge1, const vec<3, double>& x)
{
    return detail::core::common::smoothstep::_default_dv(_mm256_set1_pd(edge0), _mm256_set1_pd(edge1), x());
}
...
{
    return detail::core::common::smoothstep::_default_fv(edge0.si128(), edge1.si128(), x.si128());
}
template<> inline glm2::vec<3, float> glm2::smoothstep(const vec<3, float>& edge0, const vec<3, float>& edge1, const vec<3, float>& x)
{
    return detail::core::common::smoothstep::_default_fv(edge0(), edge1(), x());
}
...
{
    return detail::core::common::smoothstep::_default_dv2(edge0(), edge1(), x());
}
template<> inline glm2::vec<3, double> glm2::smoothstep(const vec<3, double>& edge0, const vec<3, double>& edge1, const vec<3, double>& x)
{
    return detail::core::common::smoothstep::_default_dv(edge0(), edge1(), x());
}
