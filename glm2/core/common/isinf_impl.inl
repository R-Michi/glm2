...
{
    return detail::core::common::isinf::_default_fv(x.si128());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::isinf(const vec<3, float>& x)
{
    return detail::core::common::isinf::_default_fv(x());
}
...
{
    return detail::core::common::isinf::_default_dv2(x());
}
template<> inline glm2::vec<3, glm2::bool32_t> glm2::isinf(const vec<3, double>& x)
{
    return detail::core::common::isinf::_default_dv(x());
}
