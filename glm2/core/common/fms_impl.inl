...
{
    return detail::core::common::fms::_default_fv(a.si128(), b.si128(), c.si128());
}
template<> inline glm2::vec<3, float> glm2::fms(const vec<3, float>& a, const vec<3, float>& b, const vec<3, float>& c)
{
    return detail::core::common::fms::_default_fv(a(), b(), c());
}
