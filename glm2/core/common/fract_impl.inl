...
{
    return detail::core::common::fract::_default_fv(x.si128());
}
template<> inline glm2::vec<3, float> glm2::fract(const vec<3, float>& x)
{
    return detail::core::common::fract::_default_fv(x());
}
...
{
    return detail::core::common::fract::_default_dv2(x());
}
template<> inline glm2::vec<3, double> glm2::fract(const vec<3, double>& x)
{
    return detail::core::common::fract::_default_dv(x());
}
