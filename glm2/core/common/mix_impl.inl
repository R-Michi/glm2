...
{
    return detail::core::common::mix::_default_fv(x.intrinEXT(), y.intrinEXT(), _mm_set_ps1(a));
}
template<> inline glm2::vec<3, float> glm2::mix(const vec<3, float>& x, const vec<3, float>& y, float a)
{
    return detail::core::common::mix::_default_fv(x.intrin(), y.intrin(), _mm_set_ps1(a));
}
...
{
    return detail::core::common::mix::_default_dv2(x.intrin(), y.intrin(), _mm_set1_pd(a));
}
template<> inline glm2::vec<3, double> glm2::mix(const vec<3, double>& x, const vec<3, double>& y, double a)
{
    return detail::core::common::mix::_default_dv(x.intrin(), y.intrin(), _mm256_set1_pd(a));
}
...
{
    return detail::core::common::mix::_default_fv(x.intrinEXT(), y.intrinEXT(), a.intrinEXT());
}
template<> inline glm2::vec<3, float> glm2::mix(const vec<3, float>& x, const vec<3, float>& y, const vec<3, float>& a)
{
    return detail::core::common::mix::_default_fv(x.intrin(), y.intrin(), a.intrin());
}
...
{
    return detail::core::common::mix::_default_dv2(x.intrin(), y.intrin(), a.intrin());
}
template<> inline glm2::vec<3, double> glm2::mix(const vec<3, double>& x, const vec<3, double>& y, const vec<3, double>& a)
{
    return detail::core::common::mix::_default_dv(x.intrin(), y.intrin(), a.intrin());
}
