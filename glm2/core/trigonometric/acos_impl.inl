/**
* @file     acos_impl.inl
* @brief    Implementation of acos function.
...
template<> inline float glm2::acos(float x)
{
    return detail::core::trigonometric::acos::_default_f(x);
}
template<> inline double glm2::acos(double x)
{
    return detail::core::trigonometric::acos::_default_d(x);
}
