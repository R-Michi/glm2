...
{
    return detail::core::trigonometric::atan::_default_fv2(x.si128());
}
template<> inline glm2::vec<3, float> glm2::atan(const vec<3, float>& x)
{
    return detail::core::trigonometric::atan::_default_fv3(x());
}
template<> inline glm2::vec<4, float> glm2::atan(const vec<4, float>& x)
{
    return detail::core::trigonometric::atan::_default_fv4(x());
}


template<> inline glm2::vec<2, double> glm2::atan(const vec<2, double>& x)
{
    return detail::core::trigonometric::atan::_default_dv2(x());
}
template<> inline glm2::vec<3, double> glm2::atan(const vec<3, double>& x)
{
    return detail::core::trigonometric::atan::_default_dv3(x());
}
template<> inline glm2::vec<4, double> glm2::atan(const vec<4, double>& x)
{
    return detail::core::trigonometric::atan::_default_dv4(x());
}